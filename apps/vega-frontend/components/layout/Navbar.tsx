      ...
      <div className={`border-b transition-all duration-300 ${scrolled ? "bg-white/95 backdrop-blur-md border-gray-200 shadow-lg" : "bg-white border-gray-100"}`}>
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
          <Link href={l("/")} className="flex items-center shrink-0">
            <img src="/images/logo/logo.jpeg" alt="Vega" className="h-14 sm:hidden w-auto object-contain" draggable={false} onContextMenu={(e) => e.preventDefault()} />
            <img src="/images/logo/final-logo.png" alt="Vega" className="hidden sm:block h-20 w-auto object-contain" draggable={false} onContextMenu={(e) => e.preventDefault()} />
          </Link>
