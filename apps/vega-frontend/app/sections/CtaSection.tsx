  ...
  return (
    <section className="py-24 bg-gray-900">
      <div className="mx-auto max-w-3xl px-6 text-center">
        ...
        <h2 className="text-3xl font-light text-white md:text-4xl lg:text-5xl leading-tight">
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-3">
          <Link href="/contact-us" className="rounded-full border border-white/30 px-7 py-3 text-sm text-white hover:bg-white hover:text-gray-900 transition-all duration-300">
            Request a Quote <ArrowRight className="ml-2 inline h-4 w-4" />
          </Link>
          <Link href="/catalog" className="rounded-full border border-white/30 px-7 py-3 text-sm text-white hover:bg-white hover:text-gray-900 transition-all duration-300">
            Download Catalog
          </Link>
        </div>
      </div>
